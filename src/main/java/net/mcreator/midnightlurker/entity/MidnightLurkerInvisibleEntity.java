...
import net.mcreator.midnightlurker.entity.hurt.MidnightLurkerInvisibleEntityIsHurtProcedure;
...
import net.mcreator.midnightlurker.entity.tick.MidnightLurkerInvisibleOnEntityTickUpdateProcedure;
...
public class MidnightLurkerInvisibleEntity extends HostileEntity implements GeoEntity {
	public static final TrackedData<Boolean> SHOOT = DataTracker.registerData(MidnightLurkerInvisibleEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	public static final TrackedData<String> ANIMATION = DataTracker.registerData(MidnightLurkerInvisibleEntity.class, TrackedDataHandlerRegistry.STRING);
	public static final TrackedData<String> TEXTURE = DataTracker.registerData(MidnightLurkerInvisibleEntity.class, TrackedDataHandlerRegistry.STRING);
	...
	protected void initDataTracker(DataTracker.Builder builder) {
		super.initDataTracker(builder
				...
				.add(TEXTURE, "midnightlurkervoidgateemissive")
		);
	}
	...
	public boolean damage(DamageSource source, float amount) {
		MidnightLurkerInvisibleEntityIsHurtProcedure.execute(this.getWorld(), this.getX(), this.getY(), this.getZ(), this);
	...
	public void baseTick() {
		super.baseTick();
		MidnightLurkerInvisibleOnEntityTickUpdateProcedure.execute(this.getWorld(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		BiomeModifications.addSpawn(BiomeSelectors.all(), SpawnGroup.MONSTER, MidnightlurkerModEntities.MIDNIGHT_LURKER_INVISIBLE, 9, 1, 1);
		SpawnRestriction.register(MidnightlurkerModEntities.MIDNIGHT_LURKER_INVISIBLE, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	protected void updatePostDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MidnightLurkerInvisibleEntity.RemovalReason.KILLED);
			this.dropXp(null);
		}
	}
