...
public class MidnightLurkerRuntrueEntity extends HostileEntity implements GeoEntity {
	public static final TrackedData<Boolean> SHOOT = DataTracker.registerData(MidnightLurkerRuntrueEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	public static final TrackedData<String> ANIMATION = DataTracker.registerData(MidnightLurkerRuntrueEntity.class, TrackedDataHandlerRegistry.STRING);
	public static final TrackedData<String> TEXTURE = DataTracker.registerData(MidnightLurkerRuntrueEntity.class, TrackedDataHandlerRegistry.STRING);
	...
	protected void initGoals() {
		...
		this.goalSelector.add(5, new SwimGoal(this) {
			...
			public boolean canStart() {
				...
				World world = MidnightLurkerRuntrueEntity.this.getWorld();
