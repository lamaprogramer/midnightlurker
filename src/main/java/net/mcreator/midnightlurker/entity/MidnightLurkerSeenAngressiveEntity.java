...
public class MidnightLurkerSeenAngressiveEntity extends HostileEntity implements GeoEntity, AnimatableEntity {
	...
	public static void init() {
		...
		SpawnRestriction.register(MidnightlurkerModEntities.MIDNIGHT_LURKER_SEEN_ANGRESSIVE, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
