...
public class Destroytex4Entity extends PathfinderMob {
	public Destroytex4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(MidnightlurkerModEntities.DESTROYTEX_4.get(), world);
	}

	public Destroytex4Entity(EntityType<Destroytex4Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
