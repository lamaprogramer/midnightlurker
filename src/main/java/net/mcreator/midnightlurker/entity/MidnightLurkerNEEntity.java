...
public class MidnightlurkerNEEntity extends HostileEntity implements GeoEntity {
	...
	public static void init() {
		...
		SpawnRestriction.register(MidnightlurkerModEntities.MIDNIGHTLURKER_NE, SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
