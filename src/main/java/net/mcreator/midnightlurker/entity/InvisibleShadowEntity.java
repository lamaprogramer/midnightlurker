...
public class InvisibleShadowEntity extends HostileEntity implements GeoEntity {
	...
	public static void init() {
		...
		SpawnRestriction.register(MidnightlurkerModEntities.INVISIBLE_SHADOW, SpawnLocationTypes.UNRESTRICTED, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	public static DefaultAttributeContainer.Builder createAttributes() {
		...
		builder = builder.add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.2);
