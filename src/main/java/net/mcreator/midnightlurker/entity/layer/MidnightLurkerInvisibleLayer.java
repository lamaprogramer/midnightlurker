...
public class MidnightLurkerInvisibleLayer extends GeoRenderLayer<MidnightLurkerInvisibleEntity> {
	...
	@Override
	public void render(MatrixStack poseStack, MidnightLurkerInvisibleEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
