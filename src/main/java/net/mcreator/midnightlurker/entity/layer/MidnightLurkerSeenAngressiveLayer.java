...
public class MidnightLurkerSeenAngressiveLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("midnightlurker", "textures/entities/midnightlurkerglow.png");
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkernormal.geo.json");

	public MidnightLurkerSeenAngressiveLayer(IGeoRenderer<?> entityRendererIn) {
