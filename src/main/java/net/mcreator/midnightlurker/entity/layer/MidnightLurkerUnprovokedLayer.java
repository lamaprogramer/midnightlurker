...
public class MidnightLurkerUnprovokedLayer extends GeoRenderLayer<MidnightLurkerUnprovokedEntity> {
	...
	@Override
	public void render(PoseStack poseStack, MidnightLurkerUnprovokedEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
