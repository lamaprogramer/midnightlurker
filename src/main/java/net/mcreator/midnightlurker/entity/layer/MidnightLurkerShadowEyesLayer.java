...
public class MidnightLurkerShadowEyesLayer extends GeoRenderLayer<MidnightLurkerShadowEyesEntity> {
	...
	@Override
	public void render(PoseStack poseStack, MidnightLurkerShadowEyesEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
