...
public class MidnightLurkerShadowEyesLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkershadow.geo.json");

	public MidnightLurkerShadowEyesLayer(IGeoRenderer<?> entityRendererIn) {
