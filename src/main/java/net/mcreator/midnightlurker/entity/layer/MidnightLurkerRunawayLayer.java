...
public class MidnightLurkerRunawayLayer extends GeoRenderLayer<MidnightLurkerRunawayEntity> {
	...
	@Override
	public void render(PoseStack poseStack, MidnightLurkerRunawayEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
