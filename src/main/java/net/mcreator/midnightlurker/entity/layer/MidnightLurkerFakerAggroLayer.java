...
public class MidnightLurkerFakerAggroLayer extends GeoRenderLayer<MidnightLurkerFakerAggroEntity> {
	private static final Identifier LAYER = new Identifier("midnightlurker", "textures/entities/midnightlurkerglow.png");

	public MidnightLurkerFakerAggroLayer(GeoRenderer<MidnightLurkerFakerAggroEntity> entityRenderer) {
		super(entityRenderer);
	}

	@Override
	public void render(MatrixStack poseStack, MidnightLurkerFakerAggroEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
