...
public class MidnightLurkerBackturnedLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkerbackturned.geo.json");

	public MidnightLurkerBackturnedLayer(IGeoRenderer<?> entityRendererIn) {
