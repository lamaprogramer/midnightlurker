...
public class MidnightlurkerNELayer extends GeoRenderLayer<MidnightlurkerNEEntity> {
	...
	@Override
	public void render(MatrixStack poseStack, MidnightlurkerNEEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
