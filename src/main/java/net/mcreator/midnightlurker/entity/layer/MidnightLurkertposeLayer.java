...
public class MidnightLurkertposeLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("midnightlurker", "textures/entities/midnightlurkerglow.png");
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/tposemidnightlurker.geo.json");

	public MidnightLurkertposeLayer(IGeoRenderer<?> entityRendererIn) {
