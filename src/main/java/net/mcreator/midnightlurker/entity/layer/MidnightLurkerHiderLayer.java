...
public class MidnightLurkerHiderLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkerhide.geo.json");

	public MidnightLurkerHiderLayer(IGeoRenderer<?> entityRendererIn) {
