...
public class MidnightLurkerStareLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkerstare.geo.json");

	public MidnightLurkerStareLayer(IGeoRenderer<?> entityRendererIn) {
