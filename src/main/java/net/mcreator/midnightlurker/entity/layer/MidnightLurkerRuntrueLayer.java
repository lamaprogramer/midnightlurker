...
public class MidnightLurkerRuntrueLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("midnightlurker", "geo/midnightlurkerrunaway.geo.json");

	public MidnightLurkerRuntrueLayer(IGeoRenderer<?> entityRendererIn) {
