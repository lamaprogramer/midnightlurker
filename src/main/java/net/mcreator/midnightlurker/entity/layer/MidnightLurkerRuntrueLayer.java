...
public class MidnightLurkerRuntrueLayer extends GeoRenderLayer<MidnightLurkerRuntrueEntity> {
	...
	@Override
	public void render(PoseStack poseStack, MidnightLurkerRuntrueEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
