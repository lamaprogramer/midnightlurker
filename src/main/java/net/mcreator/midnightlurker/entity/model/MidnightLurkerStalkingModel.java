...
public class MidnightLurkerStalkingModel extends AnimatedGeoModel<MidnightLurkerStalkingEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(MidnightLurkerStalkingEntity animatable, int instanceId, AnimationEvent animationEvent) {
