...
public class MidnightLurkerRunawayModel extends AnimatedGeoModel<MidnightLurkerRunawayEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(MidnightLurkerRunawayEntity animatable, int instanceId, AnimationEvent animationEvent) {
