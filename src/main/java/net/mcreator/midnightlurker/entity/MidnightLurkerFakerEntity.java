...
import net.mcreator.midnightlurker.procedures.MidnightLurkerFakerOnEntityTickUpdateProcedure;
import net.mcreator.midnightlurker.procedures.MidnightLurkerFakerEntityIsHurtProcedure;
import net.mcreator.midnightlurker.procedures.LurkerinwaterconditionProcedure;
import net.mcreator.midnightlurker.init.MidnightlurkerModEntities;

import javax.annotation.Nullable;

public class MidnightLurkerFakerEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MidnightLurkerFakerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MidnightLurkerFakerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MidnightLurkerFakerEntity.class, EntityDataSerializers.STRING);
	...
	public MidnightLurkerFakerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MidnightlurkerModEntities.MIDNIGHT_LURKER_FAKER.get(), world);
	}

	public MidnightLurkerFakerEntity(EntityType<MidnightLurkerFakerEntity> type, Level world) {
		super(type, world);
		xpReward = 25;
		setNoAi(false);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		MidnightLurkerFakerEntityIsHurtProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(MidnightlurkerModEntities.MIDNIGHT_LURKER_FAKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isShiftKeyDown()) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("backturned4", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
