...
public class MidnightLurkerShadowOnEntityTickUpdateProcedure {
	public static void execute(WorldAccess world, double x, double y, double z, Entity entity) {
		...
		if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 10, 10, 10), e -> true).isEmpty()) {
			if ((EntityUtil.getPlayerEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 10, 10, 10) instanceof LivingEntity _livEnt ? _livEnt.getMainHandStack() : ItemStack.EMPTY).getItem() == Blocks.TORCH.asItem()
