...
public class MidnightLurkerShadowNaturalEntitySpawningConditionProcedure {
	public static boolean execute(WorldAccess world, double x, double y, double z) {
		...
		if (SpawnRateHandler.shouldSpawn(lurkerSpawnRate) && multiSpawningEnabled && y < 65 && !world.isSkyVisibleAllowingSea(BlockPos.ofFloored(x, y, z))
        ...
        return SpawnRateHandler.shouldSpawn(lurkerSpawnRate) && !multiSpawningEnabled
                ...
                && (EntityUtil.hasNoEntityOfTypeInArea(world, PlayerEntity.class, new Vec3d(x, y, z), 700)) && y < 65
