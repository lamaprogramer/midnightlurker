...
public class MidnightLurkerUnprovokedEntity extends Monster implements IAnimatable {
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isInWaterOrBubble()) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("swim5", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
