...
public class MidnightLurkerFakerWatcherEntity extends HostileEntity implements GeoEntity {
	...
	public boolean damage(DamageSource source, float amount) {
		if (!MidnightLurkerFakerWatcherEntityIsHurtProcedure.execute(this))
			return false;
	...
	public static void init() {
		BiomeModifications.addSpawn(BiomeSelectors.all(), SpawnGroup.MONSTER, MidnightlurkerModEntities.MIDNIGHT_LURKER_FAKER_WATCHER, 1, 1, 1);
