...
public abstract class AnimatablePathAwareMidnightLurkerEntity extends PathAwareEntity implements GeoEntity, AnimatableEntity, AnimationHandler {
    public static final TrackedData<Boolean> SHOOT = DataTracker.registerData(AnimatablePathAwareMidnightLurkerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<String> ANIMATION = DataTracker.registerData(AnimatablePathAwareMidnightLurkerEntity.class, TrackedDataHandlerRegistry.STRING);
    public static final TrackedData<String> TEXTURE = DataTracker.registerData(AnimatablePathAwareMidnightLurkerEntity.class, TrackedDataHandlerRegistry.STRING);
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private boolean isLastLoop;
    public String animationName = "empty";

    protected AnimatablePathAwareMidnightLurkerEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
