...
public class MidnightPhantomHeadOnEntityTickUpdateProcedure {
	public static void execute(WorldAccess world, double x, double y, double z, Entity entity) {
		...
		if ((world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 33, 33, 33), e -> true).isEmpty())) {
		...
		} else if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 24, 24, 24), e -> true).isEmpty() && (world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 20, 20, 20), e -> true).isEmpty())) {
			if (entity instanceof MidnightPhantomHeadEntity animatable)
			...
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 19, 19, 19)) {
		...
		} else if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 17, 17, 17), e -> true).isEmpty() && (world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 15, 15, 15), e -> true).isEmpty())) {
			if (entity instanceof MidnightPhantomHeadEntity animatable)
				animatable.setTexture("midnightlurkerphantomhead3");
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 17, 17, 17)) {
				if (world instanceof ServerWorld _level)
					_level.getServer().getCommandManager().executeWithPrefix(new ServerCommandSource(CommandOutput.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, _level, 4, "", Text.literal(""), _level.getServer(), null).withSilent(),
			...
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 14, 14, 14)) {
				if (world instanceof ServerWorld _level)
					_level.getServer().getCommandManager().executeWithPrefix(new ServerCommandSource(CommandOutput.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, _level, 4, "", Text.literal(""), _level.getServer(), null).withSilent(),
							"/playsound midnightlurker:phantom_head_scream neutral @a ~ ~ ~ 0.5 0.2");
			}
		} else if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 11, 11, 11), e -> true).isEmpty() && (world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 8, 8, 8), e -> true).isEmpty())) {
			if (entity instanceof MidnightPhantomHeadEntity animatable)
				animatable.setTexture("midnightlurkerphantomhead5");
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 11, 11, 11)) {
				if (world instanceof ServerWorld _level)
					_level.getServer().getCommandManager().executeWithPrefix(new ServerCommandSource(CommandOutput.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, _level, 4, "", Text.literal(""), _level.getServer(), null).withSilent(),
			...
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 7, 7, 7)) {
				if (world instanceof ServerWorld _level)
					_level.getServer().getCommandManager().executeWithPrefix(new ServerCommandSource(CommandOutput.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, _level, 4, "", Text.literal(""), _level.getServer(), null).withSilent(),
			...
			if ((entity instanceof MobEntity _mobEnt ? (Entity) _mobEnt.getTarget() : null) == EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 4, 4, 4)) {
				if (world instanceof ServerWorld _level)
					_level.getServer().getCommandManager().executeWithPrefix(new ServerCommandSource(CommandOutput.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, _level, 4, "", Text.literal(""), _level.getServer(), null).withSilent(),
		...
		if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 40, 40, 40), e -> true).isEmpty()) {
			if (EntityUtil.getEntityWithRaycast(EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 40, 40, 40), entity, 40) instanceof MidnightPhantomHeadEntity) {
		...
		if (!world.getEntitiesByClass(PlayerEntity.class, Box.of(new Vec3d(x, y, z), 20, 20, 20), e -> true).isEmpty()) {
			...
			if (EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 20, 20, 20) instanceof LivingEntity _entity && !_entity.getWorld().isClient())
				...
				_entity.addStatusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 5, 200, false, false));
			{
				...
				for (Entity entityiterator : _entfound) {
					...
					{
						Entity _ent = EntityUtil.getEntityWithMinDistanceOf(world, new Vec3d(x, y, z), 20, 20, 20);
