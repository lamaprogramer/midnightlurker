...
public class InsanitysoundsProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt10 && _livEnt10.hasEffect(MidnightlurkerModMobEffects.INSANITY.get()) && entity.getPersistentData().getDouble("InsanityStage") < 7) {
			if (entity instanceof LivingEntity _livEnt12 && _livEnt12.hasEffect(MidnightlurkerModMobEffects.INSANITY.get()) && entity.getPersistentData().getDouble("InsanitySounds") == 1
		...
		} else if (entity instanceof LivingEntity _livEnt19 && _livEnt19.hasEffect(MidnightlurkerModMobEffects.INSANITY.get()) && entity.getPersistentData().getDouble("InsanityStage") >= 7) {
			if (entity instanceof LivingEntity _livEnt21 && _livEnt21.hasEffect(MidnightlurkerModMobEffects.INSANITY.get()) && entity.getPersistentData().getDouble("InsanitySounds") == 1
					&& (entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MidnightlurkerModMobEffects.INSANITY.get()) ? _livEnt.getEffect(MidnightlurkerModMobEffects.INSANITY.get()).getDuration() : 0) > 20) {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(
							new CommandSourceStack(CommandSource.NULL, new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
