...
public class MidnightLurkerShadowEyesRenderer extends GeoEntityRenderer<MidnightLurkerShadowEyesEntity> {
	...
	@Override
	public RenderType getRenderType(MidnightLurkerShadowEyesEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, MidnightLurkerShadowEyesEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
