...
public class MidnightLurkerShapeshifterRenderer extends GeoEntityRenderer<MidnightLurkerShapeshifterEntity> {
	...
	@Override
	public RenderType getRenderType(MidnightLurkerShapeshifterEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, MidnightLurkerShapeshifterEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
