...
public class MidnightLurkerStalkingRenderer extends GeoEntityRenderer<MidnightLurkerStalkingEntity> {
	...
	@Override
	public RenderType getRenderType(MidnightLurkerStalkingEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, MidnightLurkerStalkingEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
