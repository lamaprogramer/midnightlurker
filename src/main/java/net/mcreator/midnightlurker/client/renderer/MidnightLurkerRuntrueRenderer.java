...
public class MidnightLurkerRuntrueRenderer extends GeoEntityRenderer<MidnightLurkerRuntrueEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, MidnightLurkerRuntrueEntity entity, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
