...
public class MidnightLurkerSeenAngressiveRenderer extends GeoEntityRenderer<MidnightLurkerSeenAngressiveEntity> {
	...
	@Override
	public RenderType getRenderType(MidnightLurkerSeenAngressiveEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, MidnightLurkerSeenAngressiveEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay,
