...
public class MidnightLurkerBackturnedRenderer extends GeoEntityRenderer<MidnightLurkerBackturnedEntity> {
	public MidnightLurkerBackturnedRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addLayer(new MidnightLurkerBackturnedLayer(this));
	}

	@Override
	public RenderType getRenderType(MidnightLurkerBackturnedEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
