...
public class MidnightLurkerCreepRenderer extends GeoEntityRenderer<MidnightLurkerCreepEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, MidnightLurkerCreepEntity entity, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 0.95f;
