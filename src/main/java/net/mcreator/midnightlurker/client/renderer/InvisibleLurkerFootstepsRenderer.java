...
public class InvisibleLurkerFootstepsRenderer extends GeoEntityRenderer<InvisibleLurkerFootstepsEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, InvisibleLurkerFootstepsEntity entity, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
