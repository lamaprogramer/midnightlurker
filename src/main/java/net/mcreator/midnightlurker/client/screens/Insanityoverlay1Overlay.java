...
public class Insanityoverlay1Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (Insanityoverlayevent1Procedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("midnightlurker:textures/screens/insanityvignette21.png"), 0, 0, 0, 0, w, h, w, h);
		}
