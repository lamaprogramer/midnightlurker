	...
	public void onHudRender(DrawContext drawContext, float tickDelta) {
		...
		if (ShowJump2DStage1Procedure.execute(entity)) {
			if (JumpscarerFrame30Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer1stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame29Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer2stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame28Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer3stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame27Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer4stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame26Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer5stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame25Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer6stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame24Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer7stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame23Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer8stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame22Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer9stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscarerFrame21Procedure.execute(entity)) {
				drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/jumpscarer10stage1.png"), posX + -513, posY + -130, 0, 0, 1023, 528, 1023, 528);
			}
		}
