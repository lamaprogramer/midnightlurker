	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (ShowJump2Stage2Procedure.execute(entity)) {
			if (JumpscareFrame15Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond14stage2.png"));
			...
			if (JumpscareFrame14Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond13stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame13Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond12stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame12Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond11stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame11Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond10stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame10Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond9stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame9Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond8stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame8Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond7stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame7Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond6stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame6Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond5stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame5Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond4stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (Insanityoverlayevent4Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond3stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame3Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond2stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame2Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond1stage2.png"));
				Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + -513, posY + -337, 0, 0, 1023, 528, 1023, 528);
			}
			if (JumpscareFrame16Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond15stage2.png"));
			...
			if (JumpscareFrame17Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("midnightlurker:textures/screens/jumpscaresecond16stage2.png"));
