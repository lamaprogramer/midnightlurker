...
public class Insanityoverlay8Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (Insanityoverlayevent8Procedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("midnightlurker:textures/screens/insanityvignette28.png"), 0, 0, 0, 0, w, h, w, h);
		}
