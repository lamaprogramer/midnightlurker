...
public class Insanityoverlay4Overlay implements HudRenderCallback {
	...
	public void onHudRender(DrawContext drawContext, float tickDelta) {
		...
		if (Insanityoverlayevent4Procedure.execute(entity)) {
			drawContext.drawTexture(new Identifier("midnightlurker:textures/screens/insanityvignette24.png"), 0, 0, 0, 0, w, h, w, h);
		}
