...
public class Insanityoverlay4Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (Insanityoverlayevent4Procedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("midnightlurker:textures/screens/insanityvignette24.png"), 0, 0, 0, 0, w, h, w, h);
		}
